...
public class CategoriaController {
	...
	public ResponseEntity<List<Categoria>>getByAvaliacao(@PathVariable String avaliacao){
		return ResponseEntity.ok(categoriaRepository.findAllByAvaliacaoContainingIgnoreCase(avaliacao));	
	}
